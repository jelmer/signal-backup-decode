		...
		descriptor.get(|| {
			...
			fields.push(
				::protobuf::reflect::accessor::make_repeated_field_accessor::<
					_,
					::protobuf::types::ProtobufTypeMessage<SqlStatement_SqlParameter>,
				>(
					"parameters",
...
impl ::protobuf::Message for SqlStatement_SqlParameter {
	...
	fn default_instance() -> &'static SqlStatement_SqlParameter {
		static instance: ::protobuf::rt::LazyV2<SqlStatement_SqlParameter> =
			::protobuf::rt::LazyV2::INIT;
		...
		descriptor.get(|| {
			...
			fields.push(
				::protobuf::reflect::accessor::make_singular_field_accessor::<
					_,
					::protobuf::types::ProtobufTypeString,
				>("name", |m: &Avatar| &m.name, |m: &mut Avatar| &mut m.name),
			);
			fields.push(
				::protobuf::reflect::accessor::make_singular_field_accessor::<
					_,
		...
		descriptor.get(|| {
			...
			fields.push(
				::protobuf::reflect::accessor::make_singular_field_accessor::<
					_,
					::protobuf::types::ProtobufTypeBytes,
				>("iv", |m: &Header| &m.iv, |m: &mut Header| &mut m.iv),
			);
			fields.push(
				::protobuf::reflect::accessor::make_singular_field_accessor::<
					_,
					::protobuf::types::ProtobufTypeBytes,
				>("salt", |m: &Header| &m.salt, |m: &mut Header| &mut m.salt),
			);
			fields.push(::protobuf::reflect::accessor::make_option_accessor::<
				_,
				::protobuf::types::ProtobufTypeUint32,
		...
		descriptor.get(|| {
			...
			fields.push(
				::protobuf::reflect::accessor::make_singular_field_accessor::<
					_,
					::protobuf::types::ProtobufTypeString,
				>("key", |m: &KeyValue| &m.key, |m: &mut KeyValue| &mut m.key),
			);
			fields.push(
				::protobuf::reflect::accessor::make_singular_field_accessor::<
					_,
...
impl BackupFrame {
	...
	pub fn get_header(&self) -> &Header {
		self.header
			.as_ref()
			.unwrap_or_else(|| <Header as ::protobuf::Message>::default_instance())
	}
	...
	pub fn get_statement(&self) -> &SqlStatement {
		self.statement
			.as_ref()
			.unwrap_or_else(|| <SqlStatement as ::protobuf::Message>::default_instance())
	}
	pub fn clear_statement(&mut self) {
		self.statement.clear();
	}
	...
	pub fn get_preference(&self) -> &SharedPreference {
		self.preference
			.as_ref()
			.unwrap_or_else(|| <SharedPreference as ::protobuf::Message>::default_instance())
	}
	...
	pub fn take_preference(&mut self) -> SharedPreference {
		self.preference
			.take()
			.unwrap_or_else(|| SharedPreference::new())
	}
	...
	pub fn get_attachment(&self) -> &Attachment {
		self.attachment
			.as_ref()
			.unwrap_or_else(|| <Attachment as ::protobuf::Message>::default_instance())
	}
	...
	pub fn get_version(&self) -> &DatabaseVersion {
		self.version
			.as_ref()
			.unwrap_or_else(|| <DatabaseVersion as ::protobuf::Message>::default_instance())
	}
	pub fn clear_version(&mut self) {
		self.version.clear();
	}
	...
	pub fn take_version(&mut self) -> DatabaseVersion {
		self.version
			.take()
			.unwrap_or_else(|| DatabaseVersion::new())
	}
	...
	pub fn get_avatar(&self) -> &Avatar {
		self.avatar
			.as_ref()
			.unwrap_or_else(|| <Avatar as ::protobuf::Message>::default_instance())
	}
	...
	pub fn get_sticker(&self) -> &Sticker {
		self.sticker
			.as_ref()
			.unwrap_or_else(|| <Sticker as ::protobuf::Message>::default_instance())
	}
	...
	pub fn get_keyValue(&self) -> &KeyValue {
		self.keyValue
			.as_ref()
			.unwrap_or_else(|| <KeyValue as ::protobuf::Message>::default_instance())
	}
		...
		descriptor.get(|| {
			...
			fields.push(
				::protobuf::reflect::accessor::make_singular_ptr_field_accessor::<
					_,
					::protobuf::types::ProtobufTypeMessage<Header>,
				>(
					"header",
			...
			fields.push(
				::protobuf::reflect::accessor::make_singular_ptr_field_accessor::<
					_,
					::protobuf::types::ProtobufTypeMessage<SqlStatement>,
				>(
					"statement",
			...
			fields.push(
				::protobuf::reflect::accessor::make_singular_ptr_field_accessor::<
					_,
					::protobuf::types::ProtobufTypeMessage<SharedPreference>,
				>(
					"preference",
			...
			fields.push(
				::protobuf::reflect::accessor::make_singular_ptr_field_accessor::<
					_,
					::protobuf::types::ProtobufTypeMessage<DatabaseVersion>,
				>(
					"version",
			...
			fields.push(
				::protobuf::reflect::accessor::make_singular_ptr_field_accessor::<
					_,
					::protobuf::types::ProtobufTypeMessage<Avatar>,
				>(
					"avatar",
			...
			fields.push(
				::protobuf::reflect::accessor::make_singular_ptr_field_accessor::<
					_,
					::protobuf::types::ProtobufTypeMessage<Sticker>,
				>(
					"sticker",
			...
			fields.push(
				::protobuf::reflect::accessor::make_singular_ptr_field_accessor::<
					_,
					::protobuf::types::ProtobufTypeMessage<KeyValue>,
				>(
					"keyValue",
